        ...
        <div className="space-y-4 max-h-[40vh] overflow-y-auto pr-2 border-t border-gray-200 pt-4">
          ...
          {questions.map((q, questionIdx) => {
            ...
            return (
              ...
              >
                <p
                  className={`font-medium text-[${fontSize}px] text-gray-800 mb-2`}
                >
                  <ReactMarkdown
                ...
                <div className="space-y-1.5">
                  {q.options.map((optionText, optionIdx) => {
                    ...
                    let optionClasses = `p-2.5 rounded-md text-[${fontSize}px] flex justify-between items-center transition-colors duration-150 ease-in-out`;
                    ...
                    return (
                      <div key={optionIdx} className={optionClasses}>
                        <span>{replaceLatexInline(optionText)}</span>
                        {correctnessIndicator}
                      </div>
                    );
                  })}
